/*
///[TeamMemberInterventionRecord] model will be used for all team leader-> team member's flows (team detail screen, technician detail)
///it will have details like(user_id, client id, client details, intervention details) and visit details
*/

/// _metadata : {"status_text":"OK","status_code":200,"number_of_records":1,"message":"Success!"}
/// records : [{"id":126,"schedule_start":"2022-11-22 16:00:00","schedule_end":"2022-11-22 18:00:00","start_date":"null","end_date":"null","diff_hours":"null","longitude":"2.348803","latitude":"48.859596","comment":"null","intervention_status_id":1,"visit_id":1,"collaborator_id":8,"intervention_type_id":1,"details":{"id":1,"intervention_id":1,"confirm_ppe_ports":0,"confirm_macrons_installation":0,"confirm_top":0,"can_you_get_startedToday":0,"circuit_breaker_brand":"","month":"","year":"","test_of_vat":"","settings_anomaly":"","circuit_breaker_malfuncttion":"","meter_rate":"","full_time_rate":"","off_peak_time":"","is_the_driver_well_positioned":0,"reason_for_driver_not_well_positioned":"","identification_between_phase_and_neutral":"","presence_of_pnt":"","inversion_between_phase_and_material":"","resumption_of_enslavement":"","ict_cabling":"","photos_of_new_meter_installed":"","has_the_circuit_breaker_been_replaced":0,"reson_for_circuit_breaker_non_replacement":"","circuit_breaker_lead":"","reason_for_non_circuit_breaker_lead":"","lead_ccpi":"","indicate_reason_for_circuit_breaker_settings":"","modified_circuit_breaker_capacity":"","calibrated_power":"","reason_for_non_modified_circuit_breaker_capacity":"","status_of_installed_meter":"","enter_the_anomaly_programming":"","serial_number":"","additional_information_programming":"","circuit_breaker_properly_engaged":0,"enter_the_anomaly_circuit_breaker_interlock":"","additional_information_circuit_breaker_interlock":"","customer_feedback_comment":"","is_grip_case":0,"grip_case_reason":"","grip_case_comment":"","created_at":"","updated_at":""},"visit":{"schedule_start":"null","schedule_end":"null","start_date":"null","end_date":"null","diff_hours":"null","comment":"null","longitude":"null","latitude":"null","intervention_id":1,"visit_status_id":1,"team_leader_id":1},"client":{"id":36,"firstname":"Jimmy","lastname":"Goyette","title":"Ms.","pdl_number":"Dolor ipsum.","email":"chand@adams.com","mobile_number":"null","address":"132, rue Thompson\n29315 Eichmann-les-Bains","street":"null","postal_code":"26267","latitude":"48.85307","longitude":"2.346172","installation_instructions":"null","acc_number":"null","status":1,"city":{"id":20,"name":"Nîmes"},"market":{"id":1,"title":"null"},"technical":{"nb_fils":"null","meter_range":"null","meter_number":"null","meter_type":"null","contract_rate":"null","power_subscription":"null","meter_brand":"null"},"deployment":{"computer_accessible":"NON-ACC","address":", Nîmes, ","contract":"INACTIF"}}}]
/// errors : []

class TeamMemberInterventionRecord {
  TeamMemberInterventionRecord({
    Metadata? metadata,
  ...
  TeamMemberInterventionRecord.fromJson(dynamic json) {
  ...
  TeamMemberInterventionRecord copyWith({  Metadata? metadata,
    List<Records>? records,

  }) => TeamMemberInterventionRecord(  metadata: metadata ?? _metadata,
...
/// id : 126
/// schedule_start : "2022-11-22 16:00:00"
/// schedule_end : "2022-11-22 18:00:00"
/// start_date : "null"
/// end_date : "null"
/// diff_hours : "null"
/// longitude : "2.348803"
...
/// visit : {"schedule_start":"null","schedule_end":"null","start_date":"null","end_date":"null","diff_hours":"null","comment":"null","longitude":"null","latitude":"null","intervention_id":1,"visit_status_id":1,"team_leader_id":1}
/// client : {"id":36,"firstname":"Jimmy","lastname":"Goyette","title":"Ms.","pdl_number":"Dolor ipsum.","email":"chand@adams.com","mobile_number":"null","address":"132, rue Thompson\n29315 Eichmann-les-Bains","street":"null","postal_code":"26267","latitude":"48.85307","longitude":"2.346172","installation_instructions":"null","acc_number":"null","status":1,"city":{"id":20,"name":"Nîmes"},"market":{"id":1,"title":"null"},"technical":{"nb_fils":"null","meter_range":"null","meter_number":"null","meter_type":"null","contract_rate":"null","power_subscription":"null","meter_brand":"null"},"deployment":{"computer_accessible":"NON-ACC","address":", Nîmes, ","contract":"INACTIF"}}
...
/// lastname : "Goyette"
/// title : "Ms."
/// pdl_number : "Dolor ipsum."
/// email : "chand@adams.com"
/// mobile_number : "null"
/// address : "132, rue Thompson\n29315 Eichmann-les-Bains"
/// street : "null"
/// postal_code : "26267"
/// latitude : "48.85307"
/// longitude : "2.346172"
...
/// deployment : {"computer_accessible":"NON-ACC","address":", Nîmes, ","contract":"INACTIF"}
...
class Visit {
  ...
  Visit.fromJson(dynamic json) {
    ...
    _teamLeaderId = json['team_leader_id'];
  }
  String? _scheduleStart;
  String? _scheduleEnd;
  String? _startDate;
  ...
  int? _visitStatusId;
  int? _teamLeaderId;
  Visit copyWith({  String? scheduleStart,
    String? scheduleEnd,
    String? startDate,
    String? endDate,
    String? diffHours,
    ...
    int? visitStatusId,
    int? teamLeaderId,
  }) => Visit(  scheduleStart: scheduleStart ?? _scheduleStart,
    scheduleEnd: scheduleEnd ?? _scheduleEnd,
    startDate: startDate ?? _startDate,
    endDate: endDate ?? _endDate,
    diffHours: diffHours ?? _diffHours,
    ...
    teamLeaderId: teamLeaderId ?? _teamLeaderId,
  );
  String? get scheduleStart => _scheduleStart;
  String? get scheduleEnd => _scheduleEnd;
  String? get startDate => _startDate;
  ...
  int? get teamLeaderId => _teamLeaderId;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['team_leader_id'] = _teamLeaderId;
    return map;
  }
