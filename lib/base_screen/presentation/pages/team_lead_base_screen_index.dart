...
import 'package:imc/TeamLeader/presentation/pages/team_screen.dart';
...
class TeamLeadBaseScreenIndex extends StatefulWidget {
  const TeamLeadBaseScreenIndex({Key? key}) : super(key: key);

  @override
  State<TeamLeadBaseScreenIndex> createState() => _TeamLeadBaseScreenIndexState();
}

class _TeamLeadBaseScreenIndexState extends State<TeamLeadBaseScreenIndex> {
  ...
  ///[navigateToPage] will change the pages that are used inside the page view widget
