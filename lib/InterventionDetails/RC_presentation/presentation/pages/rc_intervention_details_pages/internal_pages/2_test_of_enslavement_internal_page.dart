...
class TestOfEnslavementInternalPage extends StatelessWidget {
  const TestOfEnslavementInternalPage({Key? key, required this.selectedPageId, required this.interventionRecordVal}) : super(key: key);
                          ...
                          GestureDetector(
                              onTap: () {
                                showModalBottomSheet(
                                  ...
                                  builder: (context) =>
                                      InterventionHelpDetailsBottomSheet(isForceGrip: true, isRc: true, interventionRecords: interventionRecordVal),
                                );
                              },
                            ...
                            child: Column(
                              children: [
                                ...
                                InterventionDetailsYesNoFlagWidget(
                                  ...
                                  value: _rcInterventionDetails.confirmEnslavementTest,
                                  onButtonPressed: (bool value) {
                                    var rcInterventionDetails = _rcInterventionDetails.copyWith(confirmEnslavementTest: value);
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                  InterventionDetailsImageContainerWidget(
                                    ...
                                    onImageSelected: (String? imageFilePath) {
                                      var rcInterventionDetails = _rcInterventionDetails.copyWith(meterEnslavementTestImage1: imageFilePath);
                                      RCInterventionDetailsHelperFunctions.saveRCInterventionDetailsInBloc(context, rcInterventionDetails);
                                    },
                                  ),
                                  InterventionDetailsImageContainerWidget(
                                    ...
                                    onImageSelected: (String? imageFilePath) {
                                      var rcInterventionDetails = _rcInterventionDetails.copyWith(meterEnslavementTestImage2: imageFilePath);
                                      RCInterventionDetailsHelperFunctions.saveRCInterventionDetailsInBloc(context, rcInterventionDetails);
                                    },
                                  ),
                                ]),
                                ...
                                InterventionDetailsTextFieldLarge(
                                  initialText: _rcInterventionDetails.additionalInfoOfEnslavementTest,
                                  ...
                                  onChanged: (String value) {
                                    ...
                                    var rcInterventionDetails = _rcInterventionDetails.copyWith(additionalInfoOfEnslavementTest: value);
                                    RCInterventionDetailsHelperFunctions.saveRCInterventionDetailsInBloc(context, rcInterventionDetails);
                                  },
                                ),
                              ],
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Padding(
                      ...
                      child: AppBoldText(appLocalizations.translate("enslavement_test"), color: AppColor.kSuccessColor, fontSize: 12),
                    ),
                  ),
                ),
              ),
