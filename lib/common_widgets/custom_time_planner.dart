...
import 'package:time_planner/src/config/GlobalConfig.dart' as Config;
import 'package:time_planner/src/TimePlannerTime.dart';
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              margin: EdgeInsets.only(
                                ...
                                //     ((dateTime.minute * Config.cellHeight!) / 60))
                                //     .toDouble(),
                                top: ((Config.cellHeight! * (_currentDate.hour)) +
                                    ((_currentDate.minute * Config.cellHeight!) / 60))
                                    .toDouble(),
                              ...
                              // height: 50,
                              color: Colors.green,
                              child: Text("${_timer}________CT_${_currentDate}"),
                            ),
                            ...
                            //     height: 10,
                            //     heightPerMinute: 10,
                            //     timeLineWidth: Config.cellWidth!.toDouble(),
                            //   ),
                            // ),
